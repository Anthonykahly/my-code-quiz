/*********************************** Variables *******************************************/
var playerScores = 0;         //Based on the total number of right Answer  10 ptos for 1 right answer
var quizTimer = 45          // 120 seconds, 8 questions x 15 seconds = 120
var intervals;
...
var remainTime = document.querySelector(".quizTimer");
...
//checking function for quizTimer variables whether it reach 0 seconds
var checkingquizTimer = function () {
    var eval = false;
    if (quizTimer <= 0) {
        quizTimer = 0;
        eval = true
...
var checkAnswer = function (str, x) {
    ...
    if (x < questions.length) {
        ...
        if (str === questions[x].answer) {
            ...
            if (!checkingquizTimer()) {
                quizTimer -= 10; // subtract 10 seconds for the quizTimer                    
            }
            showAnswer = "Wrong!";
        ...
        // call initial function ending quiz when the quizTimer reaches 0 seconds
        showInitialsScore();
    }
...
var retrieveHighScore = function () {
    ...
    creatButton("clear", "Clear High playerScores");
...
var showInitialsScore = function () {
    ...
    remainTime.textContent = "Time left :" + quizTimer;
    answer.textContent = "";
    ...
    msg.textContent = "Your final Score is: " + playerScores + " out of " + (questions.length * 10);
    ...
    container.appendChild(span);remainTime
};
...
var startHandler = function () {
    ...
    // Setting the intervals... calling the function
